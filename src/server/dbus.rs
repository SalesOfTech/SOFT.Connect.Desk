...
const DBUS_NAME: &str = "tech.salesof.softconnectdesk";
...
/// `dbus-send --session --print-reply --dest=tech.salesof.softconnectdesk /dbus tech.salesof.softconnectdesk.NewConnection string:'PEER_ID'`
