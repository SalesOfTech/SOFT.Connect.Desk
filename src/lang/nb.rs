...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter tilkobling til SOFT.Connect.Desk-nettverket..."),
        ...
        ("install_tip", "På grunn av UAC kan SOFT.Connect.Desk ikke fungere korrekt i enkelte tillfeller på fjernskrivebordet. For å unngå UAC klikker du på knappen nedenfor for å installere SOFT.Connect.Desk på systemet"),
        ("Click to upgrade", "Klikk for å oppgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For å kontrollere ditt skrivebord med fjernstyring må du gi SOFT.Connect.Desk \"Access \" Rettigheter."),
        ("config_screen", "For å kunne få adgang til ditt skrivebord med fjernstyring, må du gi SOFT.Connect.Desk \"skjerstøtte \" tillatelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhet kan kontrollere din Android-enhet via mus eller berøring, må du gi SOFT.Connect.Desk mulighet til å bruke tjenesten \"tilgjengelighet \"."),
        ("android_input_permission_tip2", "Gå til den neste systeminnstillingssiden, søk og tast inn [installerte tjenester], aktiver [SOFT.Connect.Desk Input] tjenesten."),
        ...
        ("android_open_battery_optimizations_tip", "Hvis du vil deaktivere denne funksjonen, gå til neste innstillingsside for SOFT.Connect.Desk-applikasjonen, finn og åpne [Batteri], og fjern haken ved [Ubegrenset]."),
        ...
        ("config_input", "For å kunne styre fjernskrivebordet med tastatur må du gi SOFT.Connect.Desk tillatelsen \"Inndataovervåking\"."),
        ("config_microphone", "For å kunne snakke eksternt må du gi SOFT.Connect.Desk tillatelsen \"Ta opp lyd\"."),
        ...
        ("still_click_uac_tip", "Krever fortsatt at fjernbrukeren klikker OK på UAC-vinduet til den kjørende SOFT.Connect.Desk."),
        ...
        ("verify_rustdesk_password_tip", "Verifiser SOFT.Connect.Desk-passord"),
        ...
        ("scam_text1", "Hvis du snakker i telefonen med noen du IKKE kjenner OG STOLER PÅ, som har bedt deg om å bruke SOFT.Connect.Desk og starte tjenesten, ikke fortsett og legg på umiddelbart."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Vennligst oppgrader SOFT.Connect.Desk Server Pro til versjon {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktivert på enheten din, noe som kan hindre SOFT.Connect.Desk i å fungere som det skal på den kontrollerte siden."),
        ...
        ("powered_by_me", "Drevet av SOFT.Connect.Desk"),
        ...
        ("allow-only-conn-window-open-tip", "Tillat kun tilkobling hvis SOFT.Connect.Desk-vinduet er åpent"),
        ...
        ("floating_window_tip", "Det bidrar til å holde SOFT.Connect.Desk-bakgrunnstjenesten i gang"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Vennligst oppgrader SOFT.Connect.Desk-klienten til versjon {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifiserer SOFT.Connect.Desk serversertifikatet for protokoller som bruker TLS.\nMed dette alternativet aktivert vil SOFT.Connect.Desk falle tilbake til å hoppe over verifiseringstrinnet og fortsette ved verifiseringsfeil."),
        ("Disable UDP", "Deaktiver UDP"),
        ("disable-udp-tip", "Styrer om kun TCP skal brukes.\nNår dette alternativet er aktivert, vil SOFT.Connect.Desk ikke lenger bruke UDP 21116, TCP 21116 brukes i stedet."),
        ("server-oss-not-support-tip", "MERK: SOFT.Connect.Desk server OSS inkluderer ikke denne funksjonen."),
