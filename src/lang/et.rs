...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "SOFT.Connect.Deski võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa SOFT.Connect.Desk mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et SOFT.Connect.Desk oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb SOFT.Connect.Deskile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb SOFT.Connect.Deskile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma SOFT.Connect.Deskile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [SOFT.Connect.Desk Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep RustDesk background service", "Säilita SOFT.Connect.Deski taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele SOFT.Connect.Deski rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show RustDesk", "Kuva SOFT.Connect.Desk"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma SOFT.Connect.Deskile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma SOFT.Connect.Deskile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud SOFT.Connect.Deski kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_rustdesk_password_tip", "Kinnita SOFT.Connect.Deski parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul SOFT.Connect.Deski kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda SOFT.Connect.Desk Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib SOFT.Connect.Deskil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb SOFT.Connect.Deskil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui SOFT.Connect.Deski aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada SOFT.Connect.Deski taustateenust."),
        ...
        ("About RustDesk", "SOFT.Connect.Deski teave"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Täiendage SOFT.Connect.Deski klient kaugküljel versioonile {} või uuemale!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Vaikimisi kontrollib SOFT.Connect.Desk TLS-i kasutavate protokollide puhul serveri sertifikaati.\nKui see valik on lubatud, jätab SOFT.Connect.Desk kontrollimissammu vahele ja jätkab kontrolli ebaõnnestumise korral."),
        ("Disable UDP", "Keela UDP"),
        ("disable-udp-tip", "Määrab, kas kasutada ainult TCP-d.\nKui see valik on lubatud, ei kasuta SOFT.Connect.Desk enam UDP 21116, vaid kasutatakse selle asemel TCP 21116."),
        ("server-oss-not-support-tip", "MÄRKUS: SOFT.Connect.Deski serveri OSS ei sisalda seda funktsiooni."),
