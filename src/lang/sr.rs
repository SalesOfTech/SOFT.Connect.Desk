...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Zbog UAC SOFT.Connect.Desk ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate SOFT.Connect.Desk na sistem."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfigurisanje"),
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, SOFT.Connect.Desk-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, SOFT.Connect.Desk-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite SOFT.Connect.Desk-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [SOFT.Connect.Desk Input] servis."),
        ...
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje SOFT.Connect.Desk aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ...
        ("Show RustDesk", "Prikazi SOFT.Connect.Desk"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
        ("Elevate", "Izdigni"),
        ...
        ("config_input", "Da biste upravljali udaljenom radnom površinom tastaturom, potrebno je da dodelite SOFT.Connect.Desk-u dozvolu \"Praćenje unosa\"."),
        ("config_microphone", "Da biste govorili na daljinu, potrebno je da dodelite SOFT.Connect.Desk-u dozvolu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "I dalje zahteva da udaljeni korisnik klikne OK na UAC prozoru pokrenutog SOFT.Connect.Desk-a."),
        ...
        ("verify_rustdesk_password_tip", "Potvrdi SOFT.Connect.Desk lozinku"),
        ...
        ("scam_text1", "Ako razgovarate telefonom sa nekim koga NE poznajete I kome NE VERUJETE, a ko vas je zamolio da koristite SOFT.Connect.Desk i pokrenete servis, nemojte nastaviti i odmah prekinite vezu."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Molimo nadogradite SOFT.Connect.Desk Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "SELinux je omogućen na vašem uređaju, što može sprečiti SOFT.Connect.Desk da radi pravilno kao kontrolisana strana."),
        ...
        ("allow-only-conn-window-open-tip", "Dozvoli konekciju samo ako je SOFT.Connect.Desk prozor otvoren"),
        ...
        ("floating_window_tip", "Pomaže da se SOFT.Connect.Desk pozadinski servis održi"),
        ...
        ("About RustDesk", "O SOFT.Connect.Desk-u"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Molimo nadogradite SOFT.Connect.Desk klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Podrazumevano, SOFT.Connect.Desk proverava sertifikat servera za protokole koji koriste TLS.\nSa omogućenom ovom opcijom, SOFT.Connect.Desk će preskočiti korak provere i nastaviti u slučaju neuspele provere."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Kontroliše da li se koristi samo TCP.\nKada je ova opcija omogućena, SOFT.Connect.Desk više neće koristiti UDP 21116, umesto toga će se koristiti TCP 21116."),
        ("server-oss-not-support-tip", "NAPOMENA: SOFT.Connect.Desk server OSS ne uključuje ovu funkciju."),
