...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem SOFT.Connect.Desk..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, SOFT.Connect.Desk v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate SOFT.Connect.Desku dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate SOFT.Connect.Desku dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno SOFT.Connect.Desku dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »SOFT.Connect.Desk Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep RustDesk background service", "Ohrani SOFT.Connect.Deskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije SOFT.Connect.Desk, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "SOFT.Connect.Desk potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "SOFT.Connect.Desk potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_rustdesk_password_tip", "Preveri geslo za SOFT.Connect.Desk"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite SOFT.Connect.Desk, prekinite klic in program zaprite."),
        ("scam_text2", "SOFT.Connect.Desk omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Prosimo, nadgradite SOFT.Connect.Desk Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo SOFT.Connect.Desk"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno SOFT.Connect.Deska odprto"),
        ...
        ("floating_window_tip", "Pomaga pri SOFT.Connect.Desk storitvi v ozadju"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Prosimo, nadgradite SOFT.Connect.Desk odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ...
        ("allow-insecure-tls-fallback-tip", "Privzeto SOFT.Connect.Desk preverja strežniško potrdilo za protokole, ki uporabljajo TLS.\nKo je ta možnost omogočena, bo SOFT.Connect.Desk ob neuspelem preverjanju preskočil korak preverjanja in nadaljeval."),
        ("Disable UDP", "Onemogoči UDP"),
        ("disable-udp-tip", "Določa, ali naj se uporablja samo TCP.\nKo je ta možnost omogočena, SOFT.Connect.Desk ne bo več uporabljal UDP 21116, namesto tega bo uporabljen TCP 21116."),
        ("server-oss-not-support-tip", "OPOMBA: Strežnik SOFT.Connect.Desk OSS ne vključuje te funkcije."),
