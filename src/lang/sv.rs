...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till SOFT.Connect.Desk..."),
        ...
        ("install_tip", "På grund av UAC, kan inte SOFT.Connect.Desk fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera SOFT.Connect.Desk på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge SOFT.Connect.Desk \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge SOFT.Connect.Desk \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [SOFT.Connect.Desk Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep RustDesk background service", "Behåll SOFT.Connect.Desk i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa SOFT.Connect.Desk programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("Show RustDesk", "Visa SOFT.Connect.Desk"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
        ("Elevate", "Höj upp"),
        ("Zoom cursor", "Zoom"),
        ...
        ("config_input", "För att kunna styra fjärrskrivbordet med tangentbordet måste du ge SOFT.Connect.Desk behörigheten \"Övervaka inmatning\"."),
        ("config_microphone", "För att kunna tala på distans måste du ge SOFT.Connect.Desk behörigheten \"Spela in ljud\"."),
        ...
        ("still_click_uac_tip", "Kräver fortfarande att fjärranvändaren klickar på OK i UAC-fönstret för SOFT.Connect.Desk."),
        ...
        ("verify_rustdesk_password_tip", "Verifiera SOFT.Connect.Desk-lösenord"),
        ...
        ("scam_text1", "Om du talar i telefon med någon du INTE känner OCH litar på, som har bett dig använda SOFT.Connect.Desk och starta tjänsten, fortsätt inte och lägg på omedelbart."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Uppgradera SOFT.Connect.Desk Server Pro till version {} eller senare!"),
        ...
        ("selinux_tip", "SELinux är aktiverat på din enhet, vilket kan hindra SOFT.Connect.Desk från att fungera korrekt som kontrollerad sida."),
        ("Change view", "Byt vy"),
        ...
        ("powered_by_me", "Drivs av SOFT.Connect.Desk"),
        ...
        ("allow-only-conn-window-open-tip", "Tillåt endast anslutning om SOFT.Connect.Desk-fönstret är öppet"),
        ...
        ("floating_window_tip", "Det hjälper till att hålla SOFT.Connect.Desk-bakgrundstjänsten igång"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Uppgradera SOFT.Connect.Desk-klienten till version {} eller senare på fjärrsidan!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifierar SOFT.Connect.Desk serverns certifikat för protokoll som använder TLS.\nMed detta alternativ aktiverat hoppar SOFT.Connect.Desk över verifieringssteget och fortsätter om verifieringen misslyckas."),
        ("Disable UDP", "Inaktivera UDP"),
        ("disable-udp-tip", "Styr om endast TCP ska användas.\nNär detta alternativ är aktiverat använder SOFT.Connect.Desk inte längre UDP 21116, utan TCP 21116 används i stället."),
        ("server-oss-not-support-tip", "OBS: SOFT.Connect.Desk server OSS inkluderar inte denna funktion."),
