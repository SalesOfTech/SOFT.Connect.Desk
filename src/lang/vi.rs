...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới SOFT.Connect.Desk..."),
        ...
        ("install_tip", "Do cơ chế UAC, SOFT.Connect.Desk có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt SOFT.Connect.Desk vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho SOFT.Connect.Desk."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho SOFT.Connect.Desk."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [SOFT.Connect.Desk Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep RustDesk background service", "Giữ dịch vụ SOFT.Connect.Desk chạy nền"),
        ...
        ("Show RustDesk", "Hiện SOFT.Connect.Desk"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu SOFT.Connect.Desk"),
        ...
        ("scam_text2", "Chỉ sử dụng SOFT.Connect.Desk với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ SOFT.Connect.Desk mở"),
        ...
        ("floating_window_tip", "Giữ SOFT.Connect.Desk trên cùng"),
        ...
        ("About RustDesk", "Về SOFT.Connect.Desk"),
