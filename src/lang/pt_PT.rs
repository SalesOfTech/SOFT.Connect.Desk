...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "A ligar à rede do SOFT.Connect.Desk..."),
        ...
        ("install_tip", "Devido ao UAC, o SOFT.Connect.Desk não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o SOFT.Connect.Desk no sistema."),
        ("Click to upgrade", "Clique para atualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao SOFT.Connect.Desk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao SOFT.Connect.Desk permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, você precisa permitir que o SOFT.Connect.Desk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [SOFT.Connect.Desk Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep RustDesk background service", "Manter o serviço SOFT.Connect.Desk em funcionamento"),
        ("Ignore Battery Optimizations", "Ignorar optimizações de Bateria"),
        ("android_open_battery_optimizations_tip", "Se pretender desativar esta funcionalidade, aceda à próxima página de definições da aplicação SOFT.Connect.Desk, encontre e abra [Bateria], e desmarque [Sem restrições]"),
        ...
        ("Show RustDesk", "Mostrar SOFT.Connect.Desk"),
        ("This PC", "Este PC"),
        ("or", "ou"),
        ("Elevate", "Elevar"),
        ...
        ("config_input", "Para controlar o ambiente de trabalho remoto com o teclado, é necessário conceder ao SOFT.Connect.Desk as permissões de \"Monitorização de Entrada\"."),
        ("config_microphone", "Para falar à distância, é necessário conceder ao SOFT.Connect.Desk as permissões de \"Gravar Áudio\"."),
        ...
        ("still_click_uac_tip", "Continua a exigir que o utilizador remoto clique em OK na janela do UAC do SOFT.Connect.Desk em execução."),
        ...
        ("verify_rustdesk_password_tip", "Verificar palavra-passe do SOFT.Connect.Desk"),
        ...
        ("scam_text1", "Se estiver ao telefone com alguém que NÃO conhece NEM em quem confia e que lhe pediu para usar o SOFT.Connect.Desk e iniciar o serviço, não prossiga e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o SOFT.Connect.Desk Server Pro para a versão {} ou mais recente!"),
        ...
        ("selinux_tip", "O SELinux está ativado no seu dispositivo, o que poderá impedir o SOFT.Connect.Desk de funcionar corretamente como lado controlado."),
        ...
        ("powered_by_me", "Disponibilizado pelo SOFT.Connect.Desk"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir a ligação apenas se a janela do SOFT.Connect.Desk estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço em segundo plano do SOFT.Connect.Desk"),
        ...
        ("About RustDesk", "Sobre o SOFT.Connect.Desk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente SOFT.Connect.Desk para a versão {} ou mais recente no lado remoto!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Por predefinição, o SOFT.Connect.Desk verifica o certificado do servidor para os protocolos que usam TLS.\nCom esta opção ativada, o SOFT.Connect.Desk recorrerá a ignorar a etapa de verificação e prosseguir em caso de falha de verificação."),
        ("Disable UDP", "Desativar UDP"),
        ("disable-udp-tip", "Controla se deve ser usado apenas TCP.\nQuando esta opção está ativada, o SOFT.Connect.Desk deixa de usar a UDP 21116, sendo usada a TCP 21116 em vez dela."),
        ("server-oss-not-support-tip", "NOTA: o SOFT.Connect.Desk server OSS não inclui esta funcionalidade."),
