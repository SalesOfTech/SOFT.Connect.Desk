...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään SOFT.Connect.Desk verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa SOFT.Connect.Desk ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi SOFT.Connect.Deskin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava SOFT.Connect.Deskille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava SOFT.Connect.Deskille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten SOFT.Connect.Desk daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota SOFT.Connect.Deskille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli SOFT.Connect.Desk ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "SOFT.Connect.Desk palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa SOFT.Connect.Deskin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "SOFT.Connect.Desk palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep RustDesk background service", "Pidä SOFT.Connect.Deskin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista SOFT.Connect.Deskin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show RustDesk", "Näytä SOFT.Connect.Desk"),
        ...
        ("verify_rustdesk_password_tip", "Vahvista SOFT.Connect.Desk salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "SOFT.Connect.Desk ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Päivitä SOFT.Connect.Desk Server Pro versioon {} jatkaaksesi."),
        ...
        ("About RustDesk", "Tietoa SOFT.Connect.Deskistä"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Päivitä etä-SOFT.Connect.Desk-asiakasversioon {} yhteensopivuuden takaamiseksi"),
        ...
        ("allow-insecure-tls-fallback-tip", "Oletuksena SOFT.Connect.Desk vahvistaa palvelimen varmenteen TLS:ää käyttävissä protokollissa.\nKun tämä asetus on käytössä, SOFT.Connect.Desk ohittaa vahvistusvaiheen ja jatkaa toimintaa, jos vahvistus epäonnistuu."),
        ("Disable UDP", "Poista UDP käytöstä"),
        ("disable-udp-tip", "Määrittää, käytetäänkö vain TCP:tä.\nKun tämä asetus on käytössä, SOFT.Connect.Desk ei enää käytä UDP-porttia 21116, vaan sen sijaan käytetään TCP-porttia 21116."),
        ("server-oss-not-support-tip", "HUOMAUTUS: SOFT.Connect.Desk-palvelimen OSS ei sisällä tätä ominaisuutta."),
