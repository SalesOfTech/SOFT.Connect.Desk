...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "SOFT.Connect.Desk może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować SOFT.Connect.Desk w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić SOFT.Connect.Desk przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić SOFT.Connect.Desk na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [SOFT.Connect.Desk Input]."),
        ...
        ("Language", "Język"),
        ("Keep RustDesk background service", "Zachowaj usługę SOFT.Connect.Desk w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji SOFT.Connect.Desk, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show RustDesk", "Pokaż SOFT.Connect.Desk"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji SOFT.Connect.Desk uprawnień do \"Urządzeń Wejściowych\"."),
        ("config_microphone", "Aby umożliwić zdalne rozmowy należy przyznać SOFT.Connect.Desk uprawnienia do \"Nagrań audio\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z SOFT.Connect.Desk w Twojej sieci."),
        ...
        ("verify_rustdesk_password_tip", "Weryfikuj hasło SOFT.Connect.Desk"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu SOFT.Connect.Desk - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Proszę zaktualizować SOFT.Connect.Desk Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu SOFT.Connect.Desk po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez SOFT.Connect.Desk"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno SOFT.Connect.Desk jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę SOFT.Connect.Desk w tle"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Proszę zaktualizować zdalny klient SOFT.Connect.Desk do wersji {} lub nowszej!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Domyślnie SOFT.Connect.Desk weryfikuje certyfikat serwera dla protokołów korzystających z TLS.\n Po włączeniu tej opcji, SOFT.Connect.Desk pominie etap weryfikacji i będzie kontynuował działanie w przypadku negatywnej weryfikacji."),
        ("Disable UDP", "Wyłącz protokół UDP"),
        ("disable-udp-tip", "Kontroluje, czy używać wyłącznie protokołu TCP.\nPo włączeniu tej opcji, SOFT.Connect.Desk nie będzie używać protokołu UDP 21116, zamiast niego będzie używać protokołu TCP 21116."),
        ("server-oss-not-support-tip", "UWAGA: Serwer OSS SOFT.Connect.Desk nie obsługuje tej funkcji."),
