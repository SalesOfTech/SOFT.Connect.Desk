...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "કૃપા કરીને સેટિંગ્સમાં SOFT.Connect.Desk શોધો અને તેને ચાલુ કરો."),
        ...
        ("Language", "ભાષા"),
        ("Keep RustDesk background service", "SOFT.Connect.Desk બેકગ્રાઉન્ડ સેવા ચાલુ રાખો"),
        ...
        ("Show RustDesk", "SOFT.Connect.Desk બતાવો"),
        ("This PC", "આ PC"),
        ("or", "અથવા"),
        ("Elevate", "એલિવેટ કરો"),
        ...
        ("verify_rustdesk_password_tip", "SOFT.Connect.Desk પાસવર્ડ ચકાસો"),
        ...
        ("scam_text1", "જો તમે અજાણી વ્યક્તિ સાથે વાત કરી રહ્યા હો અને તેણે SOFT.Connect.Desk વાપરવા કહ્યું હોય, તો તરત ડિસ્કનેક્ટ કરો."),
        ...
        ("allow-only-conn-window-open-tip", "માત્ર SOFT.Connect.Desk વિન્ડો ખુલ્લી હોય ત્યારે જ કનેક્શનની મંજૂરી આપો"),
        ...
        ("floating_window_tip", "બેકગ્રાઉન્ડમાં હોય ત્યારે SOFT.Connect.Desk બતાવો"),
        ...
        ("About RustDesk", "SOFT.Connect.Desk વિશે"),
