...
# Windows: python3 .\generate.py -f ..\source\flutter\build\windows\runner\Debug\ -o . -e ..\source\flutter\build\windows\runner\Debug\SOFT.Connect.Desk.exe
...
if __name__ == '__main__':
    ...
    parser.add_option("-e", "--executable", dest="executable",
                      help="specify startup file in --folder, default is SOFT.Connect.Desk.exe")
    ...
    if not options.executable:
        options.executable = 'SOFT.Connect.Desk.exe'
