...
#define HRESULT_ERR_ELEMENT_NOT_FOUND 0x80070490
    ...
    LPCWCH RD_PRINTER_PORT = L"SOFT.Connect.Desk Printer";
    LPCWCH RD_PRINTER_NAME = L"SOFT.Connect.Desk Printer";
    ...
    {
        // If the printer is used after the spooler service is started. E.g., printing a document through SOFT.Connect.Desk Printer.
