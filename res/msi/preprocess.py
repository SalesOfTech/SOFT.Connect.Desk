...
g_arpsystemcomponent = {
    ...
    "ReadMe": {
        "msi": "ARPREADME",
        "v": "https://github.com/SalesOfTech/SOFT.Connect.Desk",
    },
}
...
def make_parser():
    ...
    parser.add_argument(
        "--app-name", type=str, default="SOFT.Connect.Desk", help="The app name."
    )
    parser.add_argument(
