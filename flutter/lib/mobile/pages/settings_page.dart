...
const url = 'https://connect.salesof.tech';
          ...
          tiles: [
            SettingsTile(
                ...
                value: Padding(
                  ...
                  child: Text('connect.salesof.tech',
                      style: TextStyle(
            ...
            SettingsTile(
              ...
              onPressed: (context) =>
                  launchUrlString('https://connect.salesof.tech'),
...
void showAbout(OverlayDialogManager dialogManager) {
  dialogManager.show((setState, close, context) {
    return CustomAlertDialog(
      title:
          Text(translate('About RustDesk').replaceAll('RustDesk', appName)),
