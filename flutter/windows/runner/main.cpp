...
{
  HINSTANCE hInstance = LoadLibraryA("libsoftconnectdesk.dll");
  if (!hInstance)
  {
    std::cout << "Failed to load libsoftconnectdesk.dll." << std::endl;
    return EXIT_FAILURE;
  }
  ...
  std::wstring app_name = L"SOFT.Connect.Desk";
