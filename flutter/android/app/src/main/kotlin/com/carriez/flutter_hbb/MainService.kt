package tech.salesof.softconnectdesk
...
const val DEFAULT_NOTIFY_TITLE = "SOFT.Connect.Desk"
...
class MainService : Service() {
    ...
    private val wakeLock: PowerManager.WakeLock by lazy { powerManager.newWakeLock(PowerManager.ACQUIRE_CAUSES_WAKEUP or PowerManager.SCREEN_BRIGHT_WAKE_LOCK, "softconnectdesk:wakelock")}
    ...
    private fun initNotification() {
        ...
        notificationChannel = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channelId = "SOFT.Connect.Desk"
            val channelName = "SOFT.Connect.Desk Service"
            val channel = NotificationChannel(
                channelId,
                channelName, NotificationManager.IMPORTANCE_HIGH
            ).apply {
                description = "SOFT.Connect.Desk Service Channel"
            }
